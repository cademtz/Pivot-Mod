/*
 *	APIHook.h - Credits to Zer0Mem0ry
 *
 *	Description:
 *		Extremely NOT interesting. Turn away and don't look.
 *
 *		Very, very very stinky C++ code for hooking, don't touch unless you know some ASM.
 *		I used Zer0Mem0ry's example because it's not worth wasting time to reinventing a wheel.
 */
